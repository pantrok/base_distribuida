...
private Colonias coloniasFrame;
     ...
     */
    public Editarcolonia(Colonias coloniasFrame, Colonia colonia) {
        this.coloniasFrame = coloniasFrame;
       ...
       private void init() {
        ...
        if (!listaMunicipios.isEmpty()) {
            ...
            tb_id.setText(colonia.getId() + "");
            tb_nombre.setText(colonia.getNombre());
        } else {
            dispose();
