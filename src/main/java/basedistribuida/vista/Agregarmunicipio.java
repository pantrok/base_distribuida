...
public class Agregarmunicipio extends javax.swing.JFrame {
     ...
     */
    public Agregarmunicipio(Municipios municipiosFrame) {
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonbuscarActionPerformed
        ...
        if (tb_nombre.getText().length() > 0) {
            ...
            dispose();
            //Mensaje de actualizacion exitosa
            JOptionPane.showMessageDialog(this, "Municipio insertado correctamente", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
        } else {
